...
<body class="d-flex flex-column h-100 bg-primary">
	<main class="flex-shrink-0">
		...
		<form id="registracija" method="post" action="EditKorisnik">
			<div class="form-group row py-1">
			   <div class="col-sm-2"> </div>
				<label for="colFormLabel" class="col-sm-2 col-form-label">Username</label>
				<div class="col-sm-6">
					<input type="text" class="form-control" id="colFormLabel"
						name="username" value="<%=korisnik.getUsername()%>" disabled>
				</div>
				<div class="col-sm-2"></div>
			</div>
			<div class="form-group row py-1">
			   <div class="col-sm-2"> </div>
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="colFormLabel"
						name="imePrezime" value="<%=korisnik.getImePrezime()%>">
				</div>
				<div class="col-sm-2"></div>
			</div>
			<div class="form-group row py-1">
			   <div class="col-sm-2"> </div>
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="colFormLabel"
						name="brTel" value="<%=korisnik.getBrTel()%>">
				</div>
				<div class="col-sm-2"></div>
			</div>
			<div class="form-group row py-1">
			   <div class="col-sm-2"> </div>
				<label for="colFormLabel" class="col-sm-2 col-form-label">Poeni</label>
				<div class="col-sm-6">
					<input type="number" class="form-control" id="colFormLabel"
						name="poeni" value="<%=korisnik.getPoeni()%>">
				</div>
				<div class="col-sm-2"></div>
			</div>
			...
			<div class="form-group row py-1">
			   <div class="col-sm-2"> </div>
				<div class="col-sm-8">
					<input type="submit" class="form-control btn btn-secondary" id="colFormLabel" value="Izmeni">
				</div>
				<div class="col-sm-2"></div>
			</div>
		</form>
