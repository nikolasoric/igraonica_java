...
<body class="d-flex flex-column h-100 bg-primary">
	<main class="flex-shrink-0">
		...
		<header class="bg-primary py-5 text-white">
			<div class="container px-5">
			<form id="registracija" method="post" action="Registration">
			...
			<div class="form-group row py-1">
			   <div class="col-sm-2"> </div>
				<label for="colFormLabel" class="col-sm-2 col-form-label">Potvrdite password</label>
				<div class="col-sm-6">
					<input type="password" class="form-control" id="colFormLabel"
						name="passConf">
				</div>
			...
			<div class="row">
			   <div class="col-sm-2"> </div>
				<div class="col-sm-8 py-1" align="center">
			...
			<div class="form-group row py-1">
			   <div class="col-sm-2"> </div>
				<div class="col-sm-8">
					<input type="submit" class="form-control btn btn-secondary" id="colFormLabel" value="Registruj se">
				</div>
				<div class="col-sm-2"></div>
			</div>
		</form>
