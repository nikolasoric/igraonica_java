	...
	<main class="flex-shrink-0">
						...
						<tr>
							...
							<td>
								<form method="post" action="DeleteRezervacija">
									<input type="hidden" value="<%=rezervacija.getRezervacijaID()%>" name="rezervacijaID">
									<input type="submit" class="btn btn-secondary" value="Otkazi">
								</form>
							</td>
						</tr>
		...
		<div class="row">
			...
			<div class="col-md-10 text-white">
				...
				<a href="/Rodjendani/Home" class="text-white">Pogledajte nasu ponudu i rezervisite
					vas termin na vreme</a>
			</div>
			<div class="col-md-1"></div>
		</div>
