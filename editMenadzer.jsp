...
<body class="d-flex flex-column h-100 bg-primary">
	<main class="flex-shrink-0">
		...
		<form id="registracija" method="post" action="EditMenadzer">
			<div class="form-group row py-1">
				<div class="col-sm-2"></div>
				<label for="colFormLabel" class="col-sm-2 col-form-label">Username</label>
				<div class="col-sm-6">
					<input type="text" class="form-control" id="colFormLabel"
						name="username" value="<%=menadzer.getUsername()%>" disabled>
				</div>
				<div class="col-sm-2"></div>
			</div>
			<div class="form-group row py-1">
			...
			<div class="form-group row py-1">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="colFormLabel"
						name="brTel"  value="<%=menadzer.getBrTel()%>">
				</div>
				<div class="col-sm-2"></div>
			</div>
			...
			<div class="form-group row py-1">
				...
				<div class="col-sm-6">
					<select class="form-control" id="colFormLabel" name="agencijaID">
						<option selected  value="<%=menadzer.getAgencijaID()%>">Odaberite agenciju</option>
						<%if(agencije != null){ %>
