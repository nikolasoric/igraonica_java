...
<body class="d-flex flex-column h-100 bg-primary">
	...
	<%} %>
		...
		<form id="unos" method="post" action="InsertAgencija">
			<div class="form-group row py-1">
				...
				<div class="col-sm-6">
					<input type="number" class="form-control" id="colFormLabel"
						name="agencijaID"
						value="<%=request.getAttribute("newAgencijaID")%>" readonly>
				</div>
				<div class="col-sm-2"></div>
			</div>
			<div class="form-group row py-1">
			...
			<div class="form-group row py-1">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="colFormLabel"
						name="ponudaID" value="<%=request.getAttribute("newPonudaID")%>"
						readonly>
				</div>
				<div class="col-sm-2"></div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-8">
					<table class="table text-white">
						...
						<tbody>
							<tr>
								<td><input type="number" class="form-control col-md-8" name="osnovni"></td>
								<td><input type="number" class="form-control col-md-8" name="gaziraniSok"></td>
								<td><input type="number" class="form-control col-md-8" name="negaziraniSok"></td>
								<td><input type="number" class="form-control col-md-8" name="klovn"></td>
								<td><input type="number" class="form-control col-md-8" name="diskoteka"></td>
								<td><input type="number" class="form-control col-md-8" name="sportskeIgre"></td>
								<td><input type="number" class="form-control col-md-8" name="igraonica"></td>
							</tr>
						</tbody>
					</table>
				</div>
